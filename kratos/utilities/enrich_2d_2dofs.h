...
public:
     ...
     * 2) the second one is to capturate discontinuities in the variable(ie. pressure). it is a shape function that is zero on the nodes and has a constant discontinuity along the found interfase)
     * 
